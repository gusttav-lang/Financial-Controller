...
class Ui_addSpentMonth(object):
    ...
    def retranslateUi(self, addSpentMonth):
        ...
        self.comboBox_month.setItemText(6, QCoreApplication.translate("addSpentMonth", u"Julho", None))
        self.comboBox_month.setItemText(7, QCoreApplication.translate("addSpentMonth", u"Agosto", None))
        self.comboBox_month.setItemText(8, QCoreApplication.translate("addSpentMonth", u"Setembro", None))
        self.comboBox_month.setItemText(9, QCoreApplication.translate("addSpentMonth", u"Outubro", None))
        self.comboBox_month.setItemText(10, QCoreApplication.translate("addSpentMonth", u"Novembro", None))
        self.comboBox_month.setItemText(11, QCoreApplication.translate("addSpentMonth", u"Dezembro", None))
